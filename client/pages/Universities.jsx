      ...
      const mockUniversities = [
        {
          ...
          acceptanceRate: 43,
          programs: [
            { name: 'Computer Science', level: 'Bachelor', duration: '4 years', fee: '$58,160' },
            { name: 'Business Administration', level: 'Master', duration: '2 years', fee: '$59,290' },
            { name: 'Engineering', level: 'Bachelor', duration: '4 years', fee: '$59,290' },
            { name: 'Medicine', level: 'Doctorate', duration: '4 years', fee: '$23,530' }
          ],
          requirements: {
            englishTests: ['IELTS: 6.5', 'TOEFL: 89', 'PTE: 65'],
            academicRequirements: ['High school diploma with 75%+ average', 'SAT/ACT scores (for US students)'],
            documents: ['Transcripts', 'SOP', 'LORs', 'Resume', 'Portfolio (for specific programs)']
          },
        ...
        },
        {
          ...
          acceptanceRate: 70,
          programs: [
            { name: 'Data Science', level: 'Master', duration: '2 years', fee: '$44,736' },
            { name: 'Business Administration', level: 'Bachelor', duration: '3 years', fee: '$43,008' },
            { name: 'Engineering', level: 'Master', duration: '2 years', fee: '$45,824' }
          ],
          requirements: {
        ...
        },
        {
          ...
          acceptanceRate: 11,
          programs: [
            { name: 'Artificial Intelligence', level: 'Master', duration: '1 year', fee: '$35,900' },
            { name: 'Mechanical Engineering', level: 'Bachelor', duration: '3 years', fee: '$35,100' },
            { name: 'Finance', level: 'Master', duration: '1 year', fee: '$32,000' }
          ],
          requirements: {
            englishTests: ['IELTS: 7.0', 'TOEFL: 100', 'PTE: 69'],
            academicRequirements: ['First class honors degree or equivalent'],
            documents: ['Transcripts', 'Personal Statement', '2 References', 'CV']
          },
          applicationDeadlines: {
            september: 'July 1',
            january: 'October 1'
        ...
        },
        {
          ...
          acceptanceRate: 4,
          programs: [
            { name: 'Computer Science', level: 'Master', duration: '2 years', fee: '$57,590' },
            { name: 'Electrical Engineering', level: 'Bachelor', duration: '4 years', fee: '$57,590' },
            { name: 'Business Analytics', level: 'Master', duration: '1 year', fee: '$80,000' }
          ],
          requirements: {
            englishTests: ['IELTS: 7.5', 'TOEFL: 110', 'PTE: 75'],
            academicRequirements: ['Exceptional academic record', 'GRE/GMAT scores'],
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          ...
          <Text style={{ fontSize: '12px', display: 'block', color: '#52c41a' }}>
            {record.internationalStudents.toLocaleString()} international
          </Text>
          <Text style={{ fontSize: '12px', display: 'block', color: record.acceptanceRate < 20 ? '#ff4d4f' : '#1976d2' }}>
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          ...
          <Text style={{ fontSize: '12px', display: 'block', color: '#1976d2' }}>
            Enrolled: {record.enrollments}
          </Text>
          <Text style={{ fontSize: '11px', color: '#666' }}>
            Success: {Math.round((record.acceptances / record.applicationsSent) * 100)}%
          </Text>
        </div>
      ),
    },
    ...
    <div>
      ...
      <div style={{ marginBottom: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          ...
          <Text type="secondary">
            Manage partner universities, programs, and track application performance
          </Text>
        </div>
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
        ...
        <Col xs={24} sm={6}>
          <Card>
            <Statistic
              ...
              value={universities.reduce((acc, uni) => acc + uni.applicationsSent, 0)}
        ...
        <Col xs={24} sm={6}>
          <Card>
            <Statistic
              title="Success Rate"
              value={Math.round((universities.reduce((acc, uni) => acc + uni.acceptances, 0) / universities.reduce((acc, uni) => acc + uni.applicationsSent, 0)) * 100)}
              suffix="%"
            ...
            <Row gutter={[16, 16]} style={{ marginBottom: '24px' }}>
              ...
              <Col span={6}>
                <Card size="small">
                  <Statistic
                    ...
                    suffix="%"
                    valueStyle={{ color: selectedUniversity.acceptanceRate < 20 ? '#ff4d4f' : '#52c41a' }}
                  />
                </Card>
              </Col>
              <Col span={6}>
              ...
              <Col span={6}>
                <Card size="small">
                  <Statistic
                    title="International %"
                    value={Math.round((selectedUniversity.internationalStudents / selectedUniversity.totalStudents) * 100)}
                    suffix="%"
                        ...
                        <List.Item.Meta
                          ...
                          description={
                            <Space>
                              ...
                              <Text strong style={{ color: '#1976d2' }}>{program.fee}</Text>
                            </Space>
                          }
                        />
                      </List.Item>
              ...
              <Col span={12}>
                <Card title="Requirements" size="small">
                  <div style={{ marginBottom: '12px' }}>
                    ...
                    <br />
                    {selectedUniversity.requirements.englishTests.map((test, index) => (
                      <Tag key={index} style={{ margin: '2px' }}>{test}</Tag>
                    ))}
                  </div>
                  ...
                  <div style={{ marginBottom: '12px' }}>
                    ...
                    <br />
                    {selectedUniversity.requirements.academicRequirements.map((req, index) => (
                  ...
                  <div>
                    ...
                    <br />
                    {selectedUniversity.requirements.documents.map((doc, index) => (
                      <Tag key={index} color="blue" style={{ margin: '2px' }}>{doc}</Tag>
                    ))}
                  </div>
                </Card>
              </Col>
            ...
            <Row gutter={[16, 16]} style={{ marginTop: '16px' }}>
              <Col span={12}>
                <Card title="Application Deadlines" size="small">
                  {Object.entries(selectedUniversity.applicationDeadlines).map(([term, deadline]) => (
                    <div key={term} style={{ marginBottom: '8px' }}>
                      <Text strong style={{ textTransform: 'capitalize' }}>{term}:</Text>
                      <Text style={{ marginLeft: '8px', color: '#1976d2' }}>{deadline}</Text>
                    </div>
                  ))}
                </Card>
              </Col>
              ...
              <Col span={12}>
                <Card title="Our Performance" size="small">
                  ...
                  <Progress 
                    percent={Math.round((selectedUniversity.acceptances / selectedUniversity.applicationsSent) * 100)}
                    status="active"
                    strokeColor="#52c41a"
